...
--------------------------------------------------------------------------------
*/
#define STSYS_GetRevision() ((ST_Revision_t) "STSYS-REL_2.1.6")
...
/* Exported Functions ------------------------------------------------------- */
/* ST_ErrorCode_t STSYS_Init()
{
	return ST_NO_ERROR;
}

ST_ErrorCode_t STSYS_Term()
{
	return ST_NO_ERROR;
} */
...
U32  STSYS_MapKernelToUser(U32 Buffer, U32 Size);
U32  STSYS_UnmapKernelToUser(U32 Buffer,U32 Size);
