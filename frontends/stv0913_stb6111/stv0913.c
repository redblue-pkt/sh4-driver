 ...
 *
 * Version for:
 * Fortis FOREVER_3434HD  Tuner STV6111
 * Fortis FOREVER_NANOSMART  Tuner STV6111
 * Fortis FOREVER_9898HD  Tuner STV6111
 * Fortis DP7001  Tuner STV6111
 * Fortis FOREVER_2424HD  Tuner STV6111
 * Fortis EP8000  Tuner STV6111
 * Fortis EPP8000 Tuner STV6111
 * Fortis GPV8000 Tuner STV6111
 *
...
//#include "stv6111x.h"  /* for demodulator internal modes */

//#include "stv0913_reg.h"
//#include "stv0913_priv.h"
...
{ 54,
	{
		...
		{  90, 4959 },  /* C/N =  9.0 dB */
		{  95, 4709 },  /* C/N =  9.5 dB */
		{ 100, 4467 },  /* C/N = 10.0 dB */
		{ 105, 4236 },  /* C/N = 10.5 dB */
		{ 110, 4013 },  /* C/N = 11.0 dB */
		{ 115, 3800 },  /* C/N = 11.5 dB */
		{ 120, 3598 },  /* C/N = 12.0 dB */
		{ 125, 3406 },  /* C/N = 12.5 dB */
		{ 130, 3225 },  /* C/N = 13.0 dB */
		{ 135, 3052 },  /* C/N = 13.5 dB */
		{ 140, 2889 },  /* C/N = 14.0 dB */
		{ 145, 2733 },  /* C/N = 14.5 dB */
		{ 150, 2587 },  /* C/N = 15.0 dB */
		{ 160, 2318 },  /* C/N = 16.0 dB */
		{ 170, 2077 },  /* C/N = 17.0 dB */
		{ 180, 1862 },  /* C/N = 18.0 dB */
		{ 190, 1670 },  /* C/N = 19.0 dB */
		{ 200, 1499 },  /* C/N = 20.0 dB */
		{ 210, 1347 },  /* C/N = 21.0 dB */
		{ 220, 1213 },  /* C/N = 22.0 dB */
		{ 230, 1095 },  /* C/N = 23.0 dB */
		{ 240,  992 },  /* C/N = 24.0 dB */
		{ 250,  900 },  /* C/N = 25.0 dB */
		{ 260,  826 },  /* C/N = 26.0 dB */
		{ 270,  758 },  /* C/N = 27.0 dB */
...
typedef struct
{
	...
	unsigned char CarLoopPilotsOn_2;
	unsigned char CarLoopPilotsOff_2;
	unsigned char CarLoopPilotsOn_5;
	unsigned char CarLoopPilotsOff_5;
	unsigned char CarLoopPilotsOn_10;
	unsigned char CarLoopPilotsOff_10;
	unsigned char CarLoopPilotsOn_20;
	unsigned char CarLoopPilotsOff_20;
	unsigned char CarLoopPilotsOn_30;
	unsigned char CarLoopPilotsOff_30;
...
#ifdef CHIP_STAPI
STCHIP_Error_t FE_STV0913_RepeaterFn(STCHIP_Handle_t hChip,bool State, unsigned char *Buffer)
#else
...
int FE_STV0913_GetCarrierFrequency(STCHIP_Handle_t hChip,U32 MasterClock )
{
	int	derot,
		rem1,
		rem2,
...
int FE_STV0913_TimingGetOffset(STCHIP_Handle_t hChip,U32 SymbolRate)
{
	int timingoffset;
 ...
 */
	...
	timingoffset=((int)SymbolRate*10)/((int)0x1000000/timingoffset);
	timingoffset/= 320;
...
int FE_STV0913_GetRFLevel(STCHIP_Handle_t hChip,FE_STV0913_LOOKUP_t *lookup)
{
	int agcGain = 0,
	iqpower = 0,
	Imin,
	...
	/* Read the AGC integrator registers (2 Bytes) */
		...
		else if(agcGain>=lookup->table[lookup->size-1].regval)
		{
			...
			rfLevel =	(((int)agcGain - lookup->table[Imin].regval)
		...
		else
		{
			...
			else if(iqpower>=FE_STV0913_RF_LookUpLow.table[lookup->size-1].regval)
			{
				...
				rfLevel =	(((int)iqpower - FE_STV0913_RF_LookUpLow.table[Imin].regval)
				* (FE_STV0913_RF_LookUpLow.table[Imax].realval - FE_STV0913_RF_LookUpLow.table[Imin].realval)
				...
				rfLevel=FE_STV0913_RF_LookUpLow.table[lookup->size-1].realval;
		}
	}
	return rfLevel;
}

int FE_STV0913_CarrierGetQuality(STCHIP_Handle_t hChip,FE_STV0913_LOOKUP_t *lookup)   
{
	int c_n = -100,
	regval,
	Imin,
...
void FE_STV0913_GetLockTimeout(int *DemodTimeout,int *FecTimeout, int SymbolRate, FE_STV0913_SearchAlgo_t Algo)
{
	switch (Algo)
	{
...
bool FE_STV0913_GetDemodLock(STCHIP_Handle_t hChip,int TimeOut)
{
	int timer=0,
	lock=0;
	U32 symbolRate ;
...
bool FE_STV0913_GetFECLock(STCHIP_Handle_t hChip,int TimeOut)
{
	int timer=0,
	lock=0;
...
bool FE_STV0913_WaitForLock(STCHIP_Handle_t hChip,int DemodTimeOut,int FecTimeOut)
{
	int lock=0;
...
#if 0
int FE_STV0913_CheckVGLNAPresent(STCHIP_Handle_t hChipVGLNA)
{
	int isVGLNA =0;
...
int FE_STV0913_GetRFLevelWithVGLNA(FE_STV0913_InternalParams_t *pParams )
{
	int	Power=0,
		vglnagain=0,
		BBgain=0,
...
unsigned char FE_STV0913_GetOptimCarrierLoop(int SymbolRate,FE_STV0913_ModCod_t ModCode,int Pilots,unsigned char ChipID)
{
	unsigned char aclcValue=0x29;
	int	i;
	FE_STV0913_CarLoopOPtim *carLoopS2, *carLoopLowQpS2;
...
FE_STV0913_SIGNALTYPE_t FE_STV0913_GetSignalParams(FE_STV0913_InternalParams_t *pParams, U32 Satellite_Scan) 
{
...
BOOL FE_STV0913_BlindSearchAlgo(FE_STV0913_InternalParams_t *pParams, S32 demodTimeout, U32 Satellite_Scan)
{
	BOOL lock = TRUE;
...
FE_STV0913_SIGNALTYPE_t	FE_STV0913_Algo(FE_STV0913_InternalParams_t *pParams, U32 Satellite_Scan)
{
...
{
	S32 hmrVal, agc1InitVal, agc1PowerVal2, agc1Reg =0, agc1Field_msb=0, agc1Field_lsb=0;
