...
#define INRANGE(val, x, y)     (((x <= val) && (val <= y)) || ((y <= val) && (val <= x)) ? 1 : 0)
...
#define STB0899_SETFIELD(mask, val, width, offset) (mask & (~(((1 << width) - 1) << offset))) | ((val & ((1 << width) - 1)) << offset)
#define STB0899_SETFIELD_VAL(bitf, mask, val)      (mask = (mask & (~(((1 << STB0899_WIDTH_##bitf) - 1) << STB0899_OFFST_##bitf))) | (val << STB0899_OFFST_##bitf))
...
/* stb0899.c */
extern int stb0899_read_reg(struct stb0899_state *state, unsigned int reg);
extern u32 _stb0899_read_s2reg(struct stb0899_state *state, u32 stb0899_i2cdev, u32 stb0899_base_addr, u16 stb0899_reg_offset);
extern int stb0899_read_regs(struct stb0899_state *state, unsigned int reg, u8 *buf, u32 count);
extern int stb0899_write_regs(struct stb0899_state *state, unsigned int reg, u8 *data, u32 count);
extern int stb0899_write_reg(struct stb0899_state *state, unsigned int reg, u8 data);
extern int stb0899_write_s2reg(struct stb0899_state *state, u32 stb0899_i2cdev, u32 stb0899_base_addr, u16 stb0899_reg_offset, u32 stb0899_data);
extern int stb0899_i2c_gate_ctrl(struct dvb_frontend *fe, int enable);
#if 0
extern int _stb0899_write_s2reg(struct stb0899_state *state, u32 stb0899_i2cdev, u32 stb0899_base_addr, u16 stb0899_reg_offset, u32 stb0899_data);
#endif
