...
#define I2C_ADDR_STB0899_2 (0xd2 >> 1)  // d2 -> 0x69
#define I2C_ADDR_STB6100_2 (0xc6 >> 1)  // c6 -> 0x63 TODO: stb0899_drv.c says 0xc4!!
...
//	{ STB0899_OFF0_BB_AGC_CNTRL,       STB0899_BASE_BB_AGC_CNTRL,      0x00200c97 },  /* BBAGCCNTRL     */
	...
	{ 0xffff,                          0xffffffff,                     0xffffffff }   /* End of table   */,
};
...
static struct dvb_frontend *frontend_init(struct core_config *cfg, int i)
{
	...
	if (frontend)
	{
		dprintk(20, "STB0899 (frontend %d) attached OK\n", i);
		...
		dprintk(20, "STB6100(%d) attached OK\n", i);
	}
	else
	{
