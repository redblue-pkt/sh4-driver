...
static const char *LookupSpdifInState(int state)
{
	switch (state)
	{
		case SPDIFIN_STATE_RESET:
			return "RESET";
		case SPDIFIN_STATE_PCM_BYPASS:
			return "PCM_BYPASS";
		case SPDIFIN_STATE_COMPRESSED_BYPASS:
			return "COMPRESSED_BYPASS";
		case SPDIFIN_STATE_UNDERFLOW:
			return "UNDERFLOW";
#if DRV_MULTICOM_AUDIO_DECODER_VERSION >= 0x090128
		case SPDIFIN_STATE_COMPRESSED_MUTE:
			return "COMPRESSED_MUTE";
#endif
		default:
			return "INVALID";
	}
