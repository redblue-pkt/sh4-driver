...
static inline int OSDEV_ClaimSemaphore_trylock(OSDEV_Semaphore_t *Semaphore) //Added by Duolabs
{
...
static inline OSDEV_Status_t OSDEV_ClaimSemaphoreTimeout(OSDEV_Semaphore_t *Semaphore, unsigned int Timeout)
{
