...

{
	...
	memset(RecordedHostData, 0x00, MAX_DECODE_BUFFERS * sizeof(H264_HostData_t));
...
//
				...
				if (PPEntry != Entry)
				{
					report(severity_error, "Codec_MmeVideoH264_c::IntermediateProcess - Retrieved wrong identifier from pre-processor (%u %lu).\n", PPEntry, Entry);
					break;
				}
