...
#define SYSCONF_DEVICEID 0
 ...
 || defined(CONFIG_SH_ST_HMS1) \
 || defined(CONFIG_SH_RELOOK511) \
 || defined(CONFIG_SH_CUBEREVO_MINI) \
 || defined(CONFIG_SH_CUBEREVO) \
 || defined(CONFIG_SH_CUBEREVO_MINI2) \
 || defined(CONFIG_SH_CUBEREVO_MINI_FTA) \
 || defined(CONFIG_SH_CUBEREVO_250HD) \
 || defined(CONFIG_SH_CUBEREVO_2000HD) \
 || defined(CONFIG_SH_CUBEREVO_3000HD) \
 || defined(CONFIG_SH_IPBOX9900) \
 || defined(CONFIG_SH_IPBOX99) \
 || defined(CONFIG_SH_IPBOX55) \
 || defined(CONFIG_SH_ARIVALINK200) \
...
/*
 * The following FIR filter sets up for the DENC luma filter have been derived
