...
#ifndef _STIh205REG_H
#define _STIh205REG_H
...
/* STih205 Base addresses ----------------------------------------------------*/
#define STih205_REGISTER_BASE          0xFD000000 //TODO:

/* STih205 Base address size -------------------------------------------------*/
#define STih205_REG_ADDR_SIZE          0x01211000 //TODO:

#define STih205_PIO4                   0x00024000 //TODO:

#define STih205_TVOUT_FDMA_BASE        0x00104000
#  define STih205_HDMI_BASE              (STih205_TVOUT_FDMA_BASE + 0x0000)
#  define STih205_HDMI_SPDIF_BASE        (STih205_TVOUT_FDMA_BASE + 0x0c00)
#  define STih205_HDMI_PCMPLAYER_BASE    (STih205_TVOUT_FDMA_BASE + 0x0d00)
#  define STih205_AUX_TVOUT_BASE         (STih205_TVOUT_FDMA_BASE + 0x0e00) /* Yes, this really is in the HDMI register space on h205 */

#define STih205_TVOUT_CPU_BASE         0x01030000
#  define STih205_DENC_BASE              (STih205_TVOUT_CPU_BASE + 0x0000)
#  define STih205_VTG2_BASE              (STih205_TVOUT_CPU_BASE + 0x0200)
#  define STih205_VTG1_BASE              (STih205_TVOUT_CPU_BASE + 0x0300)
#  define STih205_MAIN_TVOUT_BASE        (STih205_TVOUT_CPU_BASE + 0x0400)
#    define STih205_FLEXDVO_BASE           (STih205_TVOUT_CPU_BASE + 0x0600)
#    define STih205_HD_FORMATTER_BASE      (STih205_TVOUT_CPU_BASE + 0x0800)
#      define STih205_HD_FORMATTER_DIG1      (STih205_HD_FORMATTER_BASE + 0x0100)
#      define STih205_HD_FORMATTER_DIG2      (STih205_HD_FORMATTER_BASE + 0x0180)
#      define STih205_HD_FORMATTER_AWGANC    (STih205_HD_FORMATTER_BASE + 0x0200)
#      define STih205_HD_FORMATTER_AWG       (STih205_HD_FORMATTER_BASE + 0x0300)
#    define STih205_CEC_BASE               (STih205_TVOUT_CPU_BASE + 0x0c00)
#define STih205_HD_FORMATTER_AWG_SIZE  64


#define STih205_AUDCFG_BASE            0x01210000
#define STih205_CLKGEN_BASE            0x01000000 // clockgen B
#define STih205_SYSCFG_BASE            0x01001000

#define STih205_BLITTER_BASE           (0x0120b000 + 0x0a00) // base + static regs offset

#define STih205_COMPOSITOR_BASE        0x0120A000
#define STih205_HD_BASE                0x01002000
#define STih205_SD_BASE                0x01003000


/* The compositor (COMP) offset addresses ------------------------------*/
#define STih205_CUR_OFFSET     0x000
#define STih205_GDP1_OFFSET    0x100
#define STih205_GDP2_OFFSET    0x200
#define STih205_GDP3_OFFSET    0x300
#define STih205_ALP_OFFSET     0x600
#define STih205_VID1_OFFSET    0x700
#define STih205_VID2_OFFSET    0x800
#define STih205_MIXER1_OFFSET  0xC00
#define STih205_MIXER2_OFFSET  0xD00
#define STih205_CAPTURE_OFFSET 0xE00

/* STih205 Display Clockgen B registers --------------------------------------*/
...
/* STih205 Sysstatus reg9, HDMI rejection PLL lock ---------------------------*/
#define SYS_STA9 0x2C
#define SYS_STA9_HDMI_PLL_LOCK   (1L<<0)

/* STih205 Sysconfig reg1, HDMI Phy compensation -----------------------------*/
#define SYS_CFG1 0x104

/* STih205 Sysconfig reg2, HDMI power off & PIO4/7 hotplug control -----------*/
...
/* STih205 Sysconfig reg3, Analogue DAC & HDMI PLL control -------------------*/
...
/* STih205 Sysconfig reg6, Video2 PIP mode -----------------------------------*/
