/***********************************************************************
 *
 * File: soc/stih205/stih205auxoutput.cpp
...
CSTih205AuxOutput::CSTih205AuxOutput(
    CSTih205Device        *pDev,
    CSTmSDVTG             *pVTG,
    CSTmTVOutDENC         *pDENC,
                                                        ...
                                                        pHDFOutput)
{
  ...
  CSTih205AuxOutput::DisableDACs();

  DEXIT();
}


void CSTih205AuxOutput::StartClocks(const stm_mode_line_t *mode)
{
  DENTRY();
...
void CSTih205AuxOutput::SetAuxClockToHDFormatter(void)
{
  DENTRY();
  /*
...
bool CSTih205AuxOutput::ShowPlane(stm_plane_id_t planeID)
{
  ULONG val;
  DEBUGF2(2,("CSTih205LocalMainOutput::ShowPlane %d\n",(int)planeID));
...
void CSTih205AuxOutput::EnableDACs(void)
{
  ULONG val;
...
void CSTih205AuxOutput::DisableDACs(void)
{
  DENTRY();
  ULONG val;
