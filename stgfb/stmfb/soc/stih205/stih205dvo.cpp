/***********************************************************************
 *
 * File: soc/stih205/stih205dvo.cpp
...
CSTih205DVO::CSTih205DVO(CDisplayDevice *pDev,
                         ...
                         ULONG           ulHDFormatterBase): CSTmHDFDVO(pDev,ulDVOBase,ulHDFormatterBase,pMasterOutput)
{
  ...
  m_pTVOutRegs   = (ULONG*)pDev->GetCtrlRegisterBase() + (STih205_MAIN_TVOUT_BASE>>2);
  m_pClkGenBRegs = (ULONG*)pDev->GetCtrlRegisterBase() + (STih205_CLKGEN_BASE>>2);

  DEXIT();
}


CSTih205DVO::~CSTih205DVO() {}


bool CSTih205DVO::SetOutputFormat(ULONG format,const stm_mode_line_t* pModeLine)
{
  DENTRY();
